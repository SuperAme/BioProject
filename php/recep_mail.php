...
$_POST['cli'];
$observ = $_POST['coment_ped'];
$pdf = $_POST['pdfBase64'];

$name = "Pedido";
$from_email = "chris3151@ciencias.unam.mx";
...
$mail->addAddress('chris3151@ciencias.unam.mx');
...
$mail->SMTPAuth = true;
$mail->Username = 'chris3151@ciencias.unam.mx';
$mail->Password = '----------';
$mail->addStringAttachment($base[0],"cotizacion.pdf");
//$mail->SMTPSecure = 'tls';
$mail->Port = 587;
...
function prepareMod () {
    ...
    foreach ($_POST["keyProds"] as $key=>$value) {        
        ...
        $subt = $value['5'];    
        $ObsProd = $value['2'];     //echo $ObsProd;
        $client = $value['6']; //echo $client;
